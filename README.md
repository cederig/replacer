...
`replacer` is a simple and fast command-line tool written in Rust that allows you to replace all occurrences of a given string with another string in a specified file.
